...
class Browser:
    ...
    def get_response(self):
        ...
        return urllib.response.addinfourl(StringIO(self.data), self._response.info(), self._response.geturl())
...
class AppHandler(urllib.request.HTTPHandler):
    ...
    def _make_response(self, result, url):
        ...
        response = urllib.response.addinfourl(StringIO(result.data), headers, url)
